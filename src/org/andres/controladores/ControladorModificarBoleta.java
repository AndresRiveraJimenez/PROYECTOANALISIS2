...
public class ControladorModificarBoleta implements Initializable {
    ...
    public void validarCamposGuardar() {
        ...
        if (txtFechaVisita.getValue() == null) {
            TrayNotification tray = new TrayNotification("ACTUALIZAR", "Debes ingresar un Fecha de visita", NotificationType.ERROR);
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.seconds(1));
            txtFechaVisita.requestFocus();
        } else if (txtHoraEntrada.getText().isEmpty()) {
            TrayNotification tray = new TrayNotification("ACTUALIZAR", "Debes ingresar una hora entrada valida", NotificationType.ERROR);
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.seconds(1));
            ...
            TrayNotification tray = new TrayNotification("ACTUALIZAR", "Debes ingresar una hora salida valida", NotificationType.ERROR);
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.seconds(1));
            ...
            TrayNotification tray = new TrayNotification("ACTUALIZAR", "Debes ingresar un Motivo", NotificationType.ERROR);
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.seconds(1));
            txtMotivo.requestFocus();
        }else if (txtDescripcion.getText().isEmpty()) {
            TrayNotification tray = new TrayNotification("ACTUALIZAR", "Debes ingresar una descripcion", NotificationType.ERROR);
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.seconds(1));
