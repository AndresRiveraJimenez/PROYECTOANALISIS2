 ...
 * @author d5
 */
public class ControladorParametrosTecnicosHoras implements Initializable{
    ...
    public Principal getEscenarioPrincipal() {
        ...
        GenerarReporte.getInstancia().GenerarReporte(parametros, "ReporteTecnicos.jasper", "Reporte de Tecnicos");
        cerrar();   
        }
